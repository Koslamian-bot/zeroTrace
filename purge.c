...
//
// Example:
//   purgeTrace.exe 1 D --test   -> writes 1 MiB zeros to PhysicalDrive1 after locking D:
//   purgeTrace.exe 1 D --purge  -> multi-pass realistic purge (0x00,0xFF,0xAA)
