...
//   zeroTrace.exe <PhysicalDriveNumber> <VolumeLetter|NONE> [--test]
//
// Example:
//   zeroTrace.exe 1 E --test   -> writes 1 MiB zeros to PhysicalDrive1 after locking E:
//   zeroTrace.exe 1 NONE       -> attempts full wipe of PhysicalDrive1 (no lock)
...
#define BUF_SIZE (512 * 1024 * 1024) // 1 MiB
...
int main(int argc, char **argv) {
    ...
    printf("Test mode: %s\n", testMode ? "YES (1 MiB only)" : "NO (full wipe)");
